...
class ProcessTiff:
	...
	def transform_all_to_psc_format(self, mode=None, th=None, lite=None, comb="c1", crop=False):
		"""
...
if __name__ == "__main__":
	...
	demo.transform_all_to_psc_format(mode="log_normal_new_noise_crop_c1", th=2, comb="c1", crop=True)
