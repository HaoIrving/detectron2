...
class ProcessTiff:
	...
	def get_new_split(self):
		...
		ret = train_val['r'][0] - 1
		train = list(ret[:400]) + list(range(500, 688))
	...
	# def get_label(self):
	# 	root_path = self.root
	# 	label = sio.loadmat(root_path + "/out/label_all.mat")
	...
	def transform_all_to_psc_format(self, mode=None, th=None, lite=None):
		...
		for split_f in [train_split_f, val_split_f]:
			...
			for x in file_names:
				...
				if mode == "log_normal_new_noise_4channel_keep4_4c4_2c2_10_blc":
					im = self.keep4_4c4_2c2_10(img_paths, int(x))
...
if __name__ == "__main__":
	...
	demo.transform_all_to_psc_format(mode="log_normal_new_noise_4channel_keep4_4c4_2c2_10_blc", th=2)
