...
if __name__ == '__main__':
    ...
    ANNOTATIONS_PATH = "datasets/sar/AIR-SARShip-2.0-xml" #xml文件所在文件夹
    CLUSTERS = 15 #聚类数量，anchor数量
    INPUTDIM = 500 #输入网络大小
...
Accuracy: 77.00%
Before Sort Ratios:
 [3.09, 4.74, 3.29, 1.14, 2.97, 1.64, 1.59, 0.7, 1.12, 0.35, 2.43, 2.96, 0.53, 0.44, 4.6]
After Sort Ratios:
 [0.35, 0.44, 0.53, 0.7, 1.12, 1.14, 1.59, 1.64, 2.43, 2.96, 2.97, 3.09, 3.29, 4.6, 4.74]
"""